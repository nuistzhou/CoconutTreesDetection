...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(787, 428)
        self.centralwidget = QtGui.QWidget(MainWindow)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.groupBoxFile = QtGui.QGroupBox(self.centralwidget)
        self.groupBoxFile.setGeometry(QtCore.QRect(560, 20, 221, 131))
        ...
        self.lblImage.setGeometry(QtCore.QRect(30, 20, 481, 331))
        ...
        self.btnOpenImage = QtGui.QPushButton(self.centralwidget)
        self.btnOpenImage.setGeometry(QtCore.QRect(420, 360, 91, 23))
