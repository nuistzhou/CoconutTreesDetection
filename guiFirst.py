...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBoxFile.setGeometry(QtCore.QRect(699, 9, 311, 661))
        self.groupBoxFile.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.groupBoxFile.setAutoFillBackground(True)
        self.groupBoxFile.setFlat(False)
        self.groupBoxFile.setCheckable(False)
        ...
        self.graphicsViewDisplay = QtGui.QGraphicsView(self.centralwidget)
        self.graphicsViewDisplay.setGeometry(QtCore.QRect(10, 10, 681, 661))
        self.graphicsViewDisplay.setAutoFillBackground(True)
        self.graphicsViewDisplay.setObjectName(_fromUtf8("graphicsViewDisplay"))
